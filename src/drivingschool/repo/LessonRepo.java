...
//    }
    ...
    public static void addLesson(int id, int pkgID, int stdID, int lessonNo, String date, String startTime, String endtTime, String grade) {
        Lesson p = new Lesson(id, pkgID, stdID, lessonNo, date, startTime, endtTime, grade);
        lessons.add(p);
    }

    public static void editLesson(String id, String pkgID, int stdID, int lessonNo, String date, String startTime, String endtTime, String grade) {
        Lesson p = null;
        boolean found = false;
    ...
    public static void listLessons() throws IOException, ClassNotFoundException {
        ...
        while (lessonsItr.hasNext()) {
            ...
            while (packagesItr.hasNext()) {
                ...
                if (pkg.getID() == lesson.getPackageID()) {
